...
pdfFile = open('relcaixa.pdf', 'rb')				#abre o arquivo do tipo binário em modo leitura.
...
pdfOutputFile = open('copyImg02.pdf', 'wb')		#cria um arquivo do tipo binário em modo escrita.
